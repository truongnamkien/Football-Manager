                    ...
                    if (isset($users)):
                        foreach ($users as $user):
                            ...
                            <tr rel="<?php echo $user['user_id'] ?>" class="inlineEdit alt-row">
                                ...
                                <td class="inlineDisable" field="user_status"><?php echo $user['user_status'] ?></td>
                                ...
                                <td class="inlineDisable">
                                    ...
                                    <a href="<?php echo site_url('admin/building_type/show?users=' . $user['user_id']) ?>"><?php echo lang('building_type_show') ?></a> | 
                                    <a href="<?php echo site_url('admin/building_type/edit?users=' . $user['user_id']) ?>"><?php echo lang('building_type_edit') ?></a>
                                </td>
                            </tr>
                            <?php
                        endforeach;
