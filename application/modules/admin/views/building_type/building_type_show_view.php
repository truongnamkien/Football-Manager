    ...
    <div class="content-box-content">
        <div id="list" class="tab-content default-tab" style="display: block;"> <!-- This is the target div. id must match the href of this div's tab -->
            <table><!-- Start Table Listing Records -->
                <tr>
                    <td class="fwb"><?php echo lang('building_type_id'); ?></td>
                    <td><?php echo $building_type_id ?></td>
                </tr>

                <tr>
                    <td class="fwb"><?php echo lang('building_type_name'); ?></td>
                    <td><?php echo $name ?></td>
                </tr>

                <tr>
                    <td class="fwb"><?php echo lang('building_type_description'); ?></td>
                    <td><?php echo $description ?></td>
                </tr>

                <tr>
                    <td class="fwb"><?php echo lang('building_type_fee'); ?></td>
