<ul id="main-nav">
    <?php foreach ($main_navs as $main => $options): ?>
        <li> 
            <a href="<?php echo (isset($options['url']) && !empty($options['url']) ? $options['url'] : '#'); ?>" class="<?php echo (isset($options['navs']) && !empty($options['navs']) ? 'nav-top-item' : ''); ?> <?php echo ($controller == $main ? 'current' : ''); ?>">
                    ...
                    <?php foreach ($options['navs'] as $sub => $nav): ?>
                        <li>
                            <a href="<?php echo $nav; ?>" class="<?php echo ($method == $sub ? 'current' : ''); ?>">
                                <?php echo lang('navigator_sub_nav_team_' . $sub); ?>
                            </a>
                        </li>
                    <?php endforeach; ?>
                </ul>
